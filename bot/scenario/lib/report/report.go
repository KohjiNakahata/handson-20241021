...
var customMetrics = &CustomMetrics{m: map[string]map[string]*metrics{}}

func NewCustomMetrics() *CustomMetrics {
	cm := CustomMetrics{m: map[string]map[string]*metrics{}}
	return &cm
}
...
var allMetrics = []MetricsCollector{activeUsers, callCommandMetrics, pushCommandMetrics, responseCommandMetrics, customMetrics}
