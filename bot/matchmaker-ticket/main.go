...
func main() {
	...
	for running {
		...
		fmt.Printf("Success Rate       %v percent - Total:%v percent\n", int(float64(ticketSuccessCnt)/float64(ticketCnt)*float64(100)), int(float64(successTicketTotalCnt)/float64(ticketTotalCnt)*float64(100)))
		fmt.Printf("=============\n")
